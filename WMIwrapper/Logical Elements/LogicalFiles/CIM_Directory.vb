...
''' </summary>
''' <remarks>
''' <para>See <a href="http://msdn2.microsoft.com/en-us/library/aa387248(VS.85).aspx">MSDN</a>.</para>
''' </remarks>
Public MustInherit Class CIM_Directory
...
''' <summary>
''' Collection of <see cref="T:WMIwrapper.CIM_Directory"></see>.
''' </summary>
''' <remarks></remarks>
Public MustInherit Class CIM_Directories
